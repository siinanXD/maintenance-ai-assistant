  ...
  return (
    <article className="ops-panel app-card cockpit-panel cockpit-action-panel">
      <header className="ops-panel-header">
        ...
        <a className="panel-link" hidden={!canViewDashboard("tasks")} href="/tasks">
          Alle Aufgaben
        </a>
      </header>
      <div className="cockpit-panel-body cockpit-priority-body">
  ...
  return (
    <article className="ops-panel app-card cockpit-panel cockpit-assets-panel">
      <header className="ops-panel-header">
        ...
        <a className="panel-link" hidden={!canViewDashboard("machines")} href="/machines">
          Maschinen
        </a>
      </header>
  ...
  return (
    <article className="ops-panel app-card cockpit-panel cockpit-people-panel">
      <header className="ops-panel-header">
        ...
        <a className="panel-link" hidden={!canViewDashboard("handover")} href="/handover">
          Übergabe
        </a>
      </header>
      <div className="cockpit-panel-body">
        ...
        <p className="briefing-summary cockpit-briefing-summary">
          {briefingSummary(dashboardState.data, dashboardState.isInsightLoading)}
        </p>
        {briefing.length ? (
          <div className="cockpit-next-list cockpit-briefing-links">
